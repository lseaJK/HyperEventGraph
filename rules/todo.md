...
### 1.3 数据存储结构设计
- [ ] 1.3.1 设计原始文本存储格式和目录结构
- [ ] 1.3.2 设计事件JSON存储结构和索引
- [ ] 1.3.3 设计unique_contexts转换格式规范
- [ ] 1.3.4 建立数据版本管理机制
- [ ] 1.3.5 实现数据备份和恢复策略
...
### 3.2 LLM事件抽取核心
- [ ] 3.2.1 集成DeepSeek V3模型进行事件识别
- [ ] 3.2.2 实现结构化输出解析和JSON格式验证
...
### 4.1 事件到超图转换模块
- [ ] 4.1.1 实现智能实体识别和标准化（公司名、人名、地名等）
- [ ] 4.1.2 设计事件超边结构（事件作为超边连接多个实体节点）
