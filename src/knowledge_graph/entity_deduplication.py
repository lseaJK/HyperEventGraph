...
class EntityDeduplicator:
    ...
    def _normalize_name(self, name: str) -> str:
        ...
        # 移除公司后缀
        # Note: This is a simple removal. More sophisticated logic might be needed.
        # The pattern ensures we match suffixes at the end of the string, possibly preceded by a space.
        for suffix in self.config.company_suffixes:
            # Create a regex pattern for the suffix to be matched at the end of the string
            # It handles optional preceding space and case-insensitivity if configured
