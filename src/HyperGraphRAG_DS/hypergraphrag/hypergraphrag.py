...
class HyperGraphRAG:
    ...
    embedding_func: callable = None  # 嵌入函数
    ollama_model: str = "quentinz/bge-large-zh-v1.5:latest"
    ...
    llm_model_func: callable = deepseek_v3_complete  # hf_model_complete
    ...
    def __post_init__(self):
        ...
        self.embedding_func = limit_async_func_call(self.embedding_func_max_async)(
            partial(ollama_embed, model=self.ollama_model)
        )

        # 手动为 embedding_func 添加属性
        self.embedding_func.embedding_dim = 1024  # 根据实际模型的嵌入维度设置
    ...
    def insert(self, string_or_strings):
        global_config = asdict(self)
        print("insert Generated Global Config:", global_config)  # 调试信息
