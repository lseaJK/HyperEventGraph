...
ssh -i "$env:USERPROFILE\.ssh\abcd.pem" -p 8080 -L 7474:localhost:7474 jfzpczlgoi@10.0.6.123 -o HostKeyAlgorithms=+ssh-rsa -o PubkeyAcceptedAlgorithms=+ssh-rsa -N
```
3. 在本地浏览器中访问前端应用
